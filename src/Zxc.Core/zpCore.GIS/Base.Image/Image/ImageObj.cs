...
namespace zpCore.Image
{
    ...
    public class ImageObj
    {
        ...
        public bool Create(string imgPath, int nWidth, int nHeight)
        {
            this.Dispose();
            Width = nWidth;
            Height = nHeight;

            Bitmap orgin = new Bitmap(imgPath);
            _imageObj = new Bitmap(orgin, nWidth, nHeight);
            _imgGraphic = Graphics.FromImage(_imageObj);
            _imgGraphic.CompositingMode = CompositingMode.SourceOver;
            _imgGraphic.CompositingQuality = CompositingQuality.HighQuality;
            _imgGraphic.InterpolationMode = InterpolationMode.HighQualityBicubic;
        ...
        public Font defaultFont(float fontSize, string fontName = "", FontStyle fontStyle = FontStyle.Regular)
        {
            Font objFont = null;
            if (fontName == "")
            {
