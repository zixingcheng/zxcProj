#-*- coding: utf-8 -*-
"""
Created on  张斌 2019-10-17 19:58:00 
    @author: zhang bin
...
mySystem.Append_Us("../Quote_Data/Data_Trade", False, __file__)
mySystem.Append_Us("", False)    
import myData, myQuote_Data, myQuote_Listener, myDataDB_StockTradeRisk 
...
class Quote_Listener_Risk_Control(myQuote_Listener.Quote_Listener):
    def __init__(self):
        ...
        self.nameAlias = "风控监测"
        self.risk = myDataDB_StockTradeRisk.myDataDB_StockTradeRisk()
