...
class Data_Stock(myQuote_Data.Quote_Data):
    ...
    def toDict(self):
        ...
        dictValue["tradeValume"] = myData_Trans.To_Float(str(self.tradeValume))
        dictValue["buy1Volume"] = myData_Trans.To_Float(str(self.buy1Volume))
        dictValue["buy1Price"] = myData_Trans.To_Float(str(self.buy1Price))
        dictValue["buy2Volume"] = myData_Trans.To_Float(str(self.buy2Volume))
        dictValue["buy2Price"] = myData_Trans.To_Float(str(self.buy2Price))
        dictValue["buy3Volume"] = myData_Trans.To_Float(str(self.buy3Volume))
        dictValue["buy3Price"] = myData_Trans.To_Float(str(self.buy3Price))
        dictValue["buy4Volume"] = myData_Trans.To_Float(str(self.buy4Volume))
        dictValue["buy5Volume"] = myData_Trans.To_Float(str(self.buy5Volume))
        dictValue["buy5Price"] = myData_Trans.To_Float(str(self.buy5Price))
        dictValue["sell1Volume"] = myData_Trans.To_Float(str(self.sell1Volume))
        dictValue["sell1Price"] = myData_Trans.To_Float(str(self.sell1Price))
        dictValue["sell2Volume"] = myData_Trans.To_Float(str(self.sell2Volume))
        dictValue["sell2Price"] = myData_Trans.To_Float(str(self.sell2Price))
        dictValue["sell3Volume"] = myData_Trans.To_Float(str(self.sell3Volume))
        dictValue["sell3Price"] = myData_Trans.To_Float(str(self.sell3Price))
        dictValue["sell4Volume"] = myData_Trans.To_Float(str(self.sell4Volume))
        dictValue["sell4Price"] = myData_Trans.To_Float(str(self.sell4Price))
        dictValue["sell5Volume"] = myData_Trans.To_Float(str(self.sell5Volume))
