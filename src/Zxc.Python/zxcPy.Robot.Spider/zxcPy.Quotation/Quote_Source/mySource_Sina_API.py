...
if __name__ == "__main__": 
    ...
    lstOpts = pSource.getOptInfos(nameETF = "50ETF", month_Delta = 1)
    print(lstOpts)
    
    print(pSource.getPrice(lstOpts[0]["source_code"], start_date="", end_date="", frequency='daily', fields=None, skip_paused=True, count=None))