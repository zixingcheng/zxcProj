...
import myData_Trans, myData_Json, myDebug, myIO, myIO_xlsx
...
class myStocks:
    def __init__(self): 
        ...
        self.Path_Stock = self.Dir_Base + "/Data/Setting/StockInfos.csv"
    ...
    def _init_Updata(self):
        ...
        if(bExist == False or tNow.tm_year != t.tm_year or tNow.tm_mon != t.tm_mon or tNow.tm_mday != t.tm_mday):
            ...
            #期权信息
            opts = []
            opts_ETF = self.quoteSource_2.getOptInfos("50ETF", extype = "sh")
            opts_ETF = opts_ETF + self.quoteSource_2.getOptInfos("300ETF", extype = "sh")
            opts = opts + opts_ETF
            for x in opts:
                pDatas = []
